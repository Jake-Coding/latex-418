...
\begin{solution}
	...
	Let the $B$ limit have projections $\pi_S$. Then, by the commutative square from the lemma $\pi_S \circ \eta_B \circ f = f$ and
	\[ \pi_S \circ \lim \Delta_f \circ \eta_A = (\Delta_f)_S \circ p_S \circ \eta_A = (\Delta_f)_S = f\] Then, because the projections all agree, by uniqueness of morphisms, $\eta_B \circ f = \lim \Delta_f \circ \eta_A$ and so $\eta$ is natural!
